...
<p align="center">
  ...
  <a href="https://portfolio-pi-ten-69.vercel.app/" target="_blank">
    <img src="https://img.shields.io/badge/Portfolio-Visit-blueviolet?style=flat&logo=vercel" alt="Portfolio" />
  </a>
...
- 🔭 Currently building with **LLMs, RAG pipelines, and MERN Stack**
- 🌱 Actively learning **LangChain, LangGraph, Django, and AI Agent architectures**
- 🤝 Open to **collaborations, research projects, and internship opportunities**
- ✍️ I regularly write about AI & ML on **[Medium](https://medium.com/@himanshux64)**
- 📄 View my resume **[here](https://drive.google.com/file/d/1yGZ26o7WLiyysw6PWk2mlbnqs5TQLeUf/view?usp=drivesdk)**
- 💬 Ask me about **Python, ML, LangChain, LangGraph, RAG, or LLM-powered applications**
- ⚡ Fun fact: My GitHub commits spike dramatically near project deadlines
...
📌 Django                  █████████░░░░░░░░   Backend for AI web apps
...
|---|---------|-------------|------------|
| 🔢 | **Handwritten Digit Classifier** | CNN-based model classifying handwritten digits on MNIST with high accuracy | Python, TensorFlow, Keras |
| 📝 | **AI Notes Summarizer** | LLM-powered app that transforms lengthy notes into clear, concise summaries | LangChain, LLMs, Streamlit |
| 🤖 | **ML Model Comparison** | Benchmarking suite comparing classification algorithms on structured datasets | Scikit-learn, Python, Matplotlib |
| 🌐 | **MERN Stack Project** *(In Progress)* | Full-stack web application with AI-assisted features | React, Node.js, Express, MongoDB |
| 🧠 | **RAG Pipeline** *(In Progress)* | Retrieval-Augmented Generation system for context-aware Q&A | LangChain, LangGraph, ChromaDB |

> 📌 Explore all projects on my **[portfolio](https://portfolio-pi-ten-69.vercel.app/)** — more being added as I build and learn.

---

## 🎯 Goals & Interests

- 🧠 **Generative AI & LLMs** — Prompt engineering, fine-tuning, and building production-ready LLM apps
- 🤖 **AI Agents** — Autonomous multi-step agents using LangGraph and tool-use frameworks
- 🔍 **RAG Systems** — Building intelligent, retrieval-augmented knowledge assistants
- 👁️ **Computer Vision** — Object detection, segmentation, and real-world visual AI
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=himanshuX64&show_icons=true&theme=tokyonight&hide_border=true" width="48%" alt="GitHub Stats"/>
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=himanshuX64&theme=tokyonight&hide_border=true" width="48%" alt="GitHub Streak"/>
</p>
...
<picture>
    ...
    <img alt="pacman contribution graph" src="https://raw.githubusercontent.com/himanshux64/himanshux64/output/pacman-contribution-graph.svg">
</picture>
